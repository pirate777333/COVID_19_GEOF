...
bar_chart_interactive=figure(x_range=x_bar_data, plot_height=900, plot_width=900)
bar_ipyw=bar_chart_interactive.vbar(x_bar_data, top=y_bar_data, color='green', width=0.5)
bar_chart_interactive.y_range=Range1d(0,5000)
...
bar_chart_interactive1=figure(x_range=x_bar_data1, plot_height=900, plot_width=900)
bar_ipyw1=bar_chart_interactive1.vbar(x_bar_data1, top=y_bar_data1, color='green', width=0.5)
bar_chart_interactive1.y_range=Range1d(0,100)
...
bar_chart_interactive2=figure(x_range=x_bar_data2, plot_height=900, plot_width=900)
bar_ipyw2=bar_chart_interactive2.vbar(x_bar_data2, top=y_bar_data2, color='green', width=0.5)
bar_chart_interactive2.y_range=Range1d(0,5000)
